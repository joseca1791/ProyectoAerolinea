...
public class PaginaPrincipalServlet extends HttpServlet {
    ...
    private void listarVuelos(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException{      
    		RequestDispatcher dispatcher = request.getRequestDispatcher("/AdministrarTiquetes.jsp");
                List<Vuelos> vuelos=aerolineaDAO.listarVuelos("n");
