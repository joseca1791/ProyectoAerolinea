...
<h1> <font face = "calibri" size = 6 color = #FFFFFF>Editar Avión</font></h1>
	<form action="adminAviones?action=confirmarEditarAvion" method="post" >
		<table>
                        <tr>
				<td><label> <font face = "calibri" size = 4 color = #FFFFFF>Codigo de Avión original: </font> </label></td>
				<td><input type="text" name="codigoOriginal" value=" <c:out value="${avion.codigo_Avion}"></c:out>" readonly="readonly"></td>
			</tr>                       

			<tr>
				<td><label><font face = "calibri" size = 4 color = #FFFFFF>Codigo de Avión nuevo: </font> </label></td>
				<td><input type="text" name="codigoAvion" value="<c:out value="${avion.codigo_Avion}"></c:out>" ></td>
			</tr>
			<tr>
				<td><label><font face = "calibri" size = 4 color = #FFFFFF>Modelo nuevo: </font> </label></td>
				<td><input type="text" name="modeloAvion" value='<c:out value="${avion.modelo}"></c:out>' ></td>
			</tr>
			<tr>
				<td><label><font face = "calibri" size = 4 color = #FFFFFF> Capacidad nueva: </font> </label></td>
