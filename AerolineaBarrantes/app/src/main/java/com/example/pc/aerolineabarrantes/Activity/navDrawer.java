...
/*    @Override
    ...
    public void abrirMantenimientoCiudades() {
        Intent intent = new Intent(this, AdmCiudadesActivity.class);
        startActivity(intent);
    }

    public void abrirMantenimientoClientes() {
        Intent intent = new Intent(this, AdmClientesActivity.class);
        startActivity(intent);
    }

    public void abrirMantenimientoVuelos() {
        Intent intent = new Intent(this, AdmVuelosActivity.class);
        startActivity(intent);
    }
