...
----------------------------------------------------------------------------------------------------------------
                                /*Informacion necesaria (al menos 1 registro por cada tabla)*/
----------------------------------------------------------------------------------------------------------------

insert into aviones values(001,Boeing777,256);
insert into ciudades values(001,Belmopan);
insert into ciudades values(002,Cairo);
insert into vuelos values(001,Belmopan,Cairo,500,15,1);
